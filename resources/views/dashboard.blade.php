                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-start">
                        <div>
                         ...
                         <a href="{{ route('colocations.show', $activeColocation) }}" class="text-indigo-600 hover:text-indigo-900 font-semibold"> 
                            Voir →
                        </a>
                    </div>
                    <div class="flex gap-4 pt-4 border-t border-gray-200">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold text-gray-900">{{ number_format($activeColocation->expenses->sum('amount'), 2, ',', '.') }}DH</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <a href="{{--{{ route('colocations.create') }}--}}" class="group">
                <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg p-8 text-white cursor-pointer hover:shadow-lg transition transform hover:scale-105 h-full">
                    ...
                    <div class="inline-block px-4 py-2 bg-white text-indigo-600 font-semibold rounded-lg group-hover:bg-indigo-50 transition">
                        Commencer →
                    </div>
                </div>
            </a>
            ...
            <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg p-8 text-white">
                ...
                <p class="text-emerald-100 mb-4">Avez-vous reçu une invitation? Acceptez-la pour rejoindre une colocation existante.</p>
